...
To optimize the ecstest application for production, run:
...
[Doing microservices with JHipster]: https://jhipster.github.io/documentation-archive/v4.4.1/microservices-architecture/
